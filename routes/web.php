...
Route::post('rounding/question/findings/delete', 'Rounding\RoundingController@deleteFinding');
Route::post('rounding/question/findings/verify', 'Rounding\RoundingController@verify');
Route::post('rounding/{rounding}/question/findings', 'Rounding\RoundingController@saveFinding');
Route::post('rounding/{rounding}/question/findings/edit', 'Rounding\RoundingController@editFinding');
...
//ilsm checklist questions
Route::get('admin/ilsm/{ilsm_id}/checklist-questions', 'Equipment\IlsmChecklistQuestionController@index');
Route::post('admin/ilsm/{ilsm_id}/checklist-questions', 'Equipment\IlsmChecklistQuestionController@store');
Route::post('admin/ilsm/checklist-questions/delete', 'Equipment\IlsmChecklistQuestionController@delete');
...
Route::post('equipment/delete', 'Equipment\EquipmentController@destroy');
