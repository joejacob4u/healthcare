...
class QuestionController extends Controller
{
    ...
    {
        return view('admin.tracer.questions', ['category' => $category]);
    }
    ...
    public function create(Category $category)
    {
        ...
        return view('admin.tracer.question-add', ['category' => $category, 'eops' => $eops, 'system_tiers' => $system_tiers]);
    }
    ...
    public function edit(Category $category, Question $question)
    {
        $eops = EOP::get(['name', 'text', 'id'])->pluck('full_name', 'id');
        $system_tiers = SystemTier::pluck('name', 'id');
        return view('admin.tracer.question-edit', ['category' => $category, 'eops' => $eops, 'system_tiers' => $system_tiers, 'question' => $question]);
    }
