...
class UsersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.healthsystem.users.index', ['users' => $users]);
    }
    ...
    public function create()
    {
        ...
        return view('frontend.healthsystem.users.add', ['healthcare_systems' => $healthcare_systems,'prospects' => $prospects]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($user->update(['role_id' => 2,'healthsystem_id' => $request->healthsystem_id])) {
            Mail::send('email.systemfrontend.welcome', [], function ($m) use ($user) {
