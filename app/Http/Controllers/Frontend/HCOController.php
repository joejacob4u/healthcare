...
class HCOController extends Controller
{
    ...
    public function add($healthsystem_id)
    {
        ...
        return view('frontend.healthsystem.hco.add', ['healthsystem' => HealthSystem::find($healthsystem_id),'accreditations' => $accreditations]);
    }
    ...
    public function edit($healthsystem_id, $id)
    {
        $hco = HCO::find($id);
        $accreditations = Accreditation::pluck('name', 'id');
        return view('frontend.healthsystem.hco.edit', ['healthsystem' => HealthSystem::find($healthsystem_id), 'hco' => $hco, 'accreditations' => $accreditations]);
    }
