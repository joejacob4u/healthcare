...
class RoomController extends Controller
{
    ...
    public function index($building_id, $department_id)
    {
        ...
        return view('frontend.healthsystem.rooms.index', ['department' => $department]);
    }
    ...
    {
        $department = BuildingDepartment::find($department_id);
        return view('frontend.healthsystem.rooms.add', ['department' => $department]);
    }
    ...
    public function edit($department_id, $room_id)
    {
        ...
        return view('frontend.healthsystem.rooms.edit', ['room' => $room]);
    }
