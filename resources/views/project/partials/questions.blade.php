...
<div class="form-group">
    ...
    <div class="col-lg-10">
        {!! Form::select('answers['.$question->id.']', $question->answers->pluck('answer','id'),$question->projects->where('id',$project->id)->first()->pivot->answer_id, ['placeholder' => 'Select answer','class' => 'form-control']); !!}
    </div>
</div>
