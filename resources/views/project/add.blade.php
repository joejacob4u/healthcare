      ...
      <div class="box-body">
        {!! Form::open(['url' => 'admin/cop/add', 'class' => 'form-horizontal']) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {!! Form::file('project_information_documents_path',['multiple' => true,'class' => 'form-control' ]); !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {!! Form::file('project_photos_directory',['multiple' => true,'class' => 'form-control' ]); !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {!! Form::select('architecture_firm_contractor_id', [], null, ['placeholder' => 'Architecture Firm','class' => 'form-control']); !!}
                </div>
            </div>
