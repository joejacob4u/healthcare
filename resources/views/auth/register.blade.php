			...
			<div class="row main">
				<div class="panel-heading">
	               <div class="panel-title text-center">
	               		<h2 class="title">Register for Contractor Admission</h2>
	               		<hr />
	               	</div>
	            </div>
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div id="optional" style="display:none">
                          <div class="form-group{{ $errors->has('corporation') ? ' has-error' : '' }}">
                              ...
                              <div class="col-md-6">
                                  <input id="corporation" type="text" class="form-control" name="corporation" value="{{ old('corporation') }}" required autofocus>
                          ...
                          <div class="form-group{{ $errors->has('partnership') ? ' has-error' : '' }}">
                              ...
                              <div class="col-md-6">
                                  <input id="partnership" type="text" class="form-control" name="partnership" value="{{ old('partnership') }}" required autofocus>
                          ...
                          <div class="form-group{{ $errors->has('sole_prop') ? ' has-error' : '' }}">
                              ...
                              <div class="col-md-6">
                                  <input id="sole_prop" type="text" class="form-control" name="sole_prop" value="{{ old('sole_prop') }}" required autofocus>
                          ...
                          <div class="form-group{{ $errors->has('company_owner') ? ' has-error' : '' }}">
                              ...
                              <div class="col-md-6">
                                  <input id="company_owner" type="text" class="form-control" name="company_owner" value="{{ old('company_owner') }}" required autofocus>
                          ...
                          <div class="form-group{{ $errors->has('contract_license_number') ? ' has-error' : '' }}">
                              ...
                              <div class="col-md-6">
                                  <input id="contract_license_number" type="text" class="form-control" name="contract_license_number" value="{{ old('contract_license_number') }}" required autofocus>
