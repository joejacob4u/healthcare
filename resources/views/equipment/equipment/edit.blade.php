      ...
      <div class="box-body">
        {!! Form::open(['url' => 'equipment/edit', 'class' => 'form-horizontal']) !!}
            ...
            <div class="form-group">
                  ...
                  <div class="col-lg-10">
                      {!! HTML::dropzone('preventive_maintenance_procedure_upload_path',$equipment->preventive_maintenance_procedure_upload_path,'true','true') !!}
                  </div>
              </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {!! Form::select('frequency', ['no_frequency' => 'No Frequency','daily' => 'Daily','weekly' => 'Weekly','monthly' => 'Monthly','quarterly' => 'Quarterly','annually' => 'Annually','semi-annually' => 'Semi-anually','as_needed' => 'As Needed' ,'per_policy' => 'Per Policy','two-years' => 'Two Years', 'three-years' => 'Three Years', 'four-years' => 'Four Years', 'five-years' => 'Five Years', 'six-years' => 'Six Years'], $equipment->frequency, ['class' => 'form-control']) !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                {!! Form::select('meet_current_oem_specifications', [1 => 'Yes',0 => 'No'], $equipment->meet_current_oem_specifications, ['class' => 'form-control','id' => 'is_warranty_available']); !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                {!! Form::select('is_manufacturer_supported', [1 => 'Yes',0 => 'No'], $equipment->is_manufacturer_supported, ['class' => 'form-control','id' => 'is_manufacturer_supported']); !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                {!! Form::select('impact_of_device_failure', ['minor' => 'Minor','major' => 'Major'], $equipment->impact_of_device_failure, ['class' => 'form-control','id' => 'impact_of_device_failure']); !!}
                </div>
            </div>
