            ...
            <fieldset>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                    {!! Form::select('maintenance_department_id[]', $departments, $user->departments->pluck('id')->toArray(), ['class' => 'form-control selectpicker','id' => 'maintenance_department_id','data-live-search' => "true"]); !!}
                    </div>
                </div>
