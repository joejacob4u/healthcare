...
@endsection
@section('page_title','Edit Tracer Category Question')
...
<ol class="breadcrumb">
    <li><a href="/admin/tracer/categories/{{$category->id}}/questions"> {{$category->name}} </a></li>
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">Edit Tracer Question for {{$category->name}}</h3>

        <div class="box-tools pull-right">
        </div>
      </div>
      <div class="box-body">
        {!! Form::open(['url' => 'admin/tracer/categories/'.$category->id.'/questions/'.$question->id.'/edit', 'class' => '']) !!}
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-lg-10 col-lg-offset-2">
                        {!! Form::submit('Update Tracer Question', ['class' => 'btn btn-success pull-right'] ) !!}
                    </div>
                </div>
  ...
  $('#system_tier_id').change(function(){
      ...
      $.ajax({
           type: 'POST',
           url: '{{ url('admin/tracer/categories/'.$category->id.'/questions/fetch-trades') }}',
    ...
    $('#work_order_trade_id').change(function(){
      ...
      $.ajax({
           type: 'POST',
           url: '{{ url('admin/tracer/categories/'.$category->id.'/questions/fetch-problems') }}',
