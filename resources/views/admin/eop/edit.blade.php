            ...
            <fieldset>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {!! Form::select('is_islm', ['0' => 'No','1' => 'Yes'], $eop->is_islm, ['class' => 'form-control','id' => 'is_islm']) !!}
                    </div>
                </div>

                

                <div class="islm form-group" @if(!$eop->is_islm) style="display:none;" @endif>
                    {!! Form::label('is_islm_shift', 'Correct ISLM during Shift ?:', ['class' => 'col-lg-2 control-label']) !!}
                    <div class="col-lg-10">
                        {!! Form::select('is_islm_shift', ['0' => 'No','1' => 'Yes'], $eop->is_islm_shift, ['class' => 'form-control','id' => 'is_islm_shift']) !!}
                    </div>
                </div>
