...
@endsection
@section('page_title','Work Order Assignees')
@section('page_description','Manage Work Order Assignees here.')
...
@include('layouts.partials.errors')
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">Work Order Assignees</h3>

        <div class="box-tools pull-right">
          <a href="{{url('admin/work/assignees/add')}}" type="button" class="btn btn-block btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Add Assignee</a>
        </div>
      </div>
      <div class="box-body">
                ...
                <tbody>
                  @foreach($assignees as $assignee)
                    <tr>
                      ...
                      <td>{!! link_to('admin/work/assignees/edit/'.$assignee->id,'Edit',['class' => 'btn-xs btn-warning']) !!}</td>
