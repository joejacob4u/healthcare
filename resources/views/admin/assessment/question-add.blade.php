...
@endsection
@section('page_title','Add Assessment Category Question')
...
<ol class="breadcrumb">
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">Add Assessment Question for {{$category->name}}</h3>

        <div class="box-tools pull-right">
        </div>
      </div>
      <div class="box-body">
        {!! Form::open(['url' => 'admin/assessment/categories/'.$category->id.'/questions', 'class' => '']) !!}
              ...
              <div id="work-order-div">
                ...
                <div class="form-group">
                    <div class="col-lg-10 col-lg-offset-2">
                        {!! Form::submit('Add Assessment Question', ['class' => 'btn btn-success pull-right'] ) !!}
                    </div>
                </div>
