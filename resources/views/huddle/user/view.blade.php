...
<div class="list-group">
    ...
    @else
        ...
        <a href="#" class="list-group-item"><span class="label label-warning">Open Safety Events</span></a>
        @foreach($assessments->where('assessment_checklist_type_id',97)->whereNotIn('assessment_status_id',[4]) as $assessment)
...
<div class="list-group">
    ...
    @else
        ...
        @foreach($assessments->where('assessment_checklist_type_id',93)->whereNotIn('assessment_status_id',[4]) as $assessment)
            <a href="{{url('/assessment/evaluate/'.$assessment->id)}}" class="list-group-item">Assessment #{{$assessment->id}}</a>
        @endforeach
    @endif
</div>
...
<div class="list-group">
    ...
    @else
        ...
        @foreach($assessment->where('assessment_checklist_type_id',92)->whereNotIn('assessment_status_id',[4]) as $assessment)
            <a href="{{url('/assessment/evaluate/'.$assessment->id)}}" class="list-group-item">Assessment #{{$assessment->id}}</a>
        @endforeach
    @endif
</div>
...
<div class="list-group">
    ...
    @else
        ...
        @foreach($assessment->where('assessment_checklist_type_id',96)->whereNotIn('assessment_status_id',[4]) as $assessment)
            <a href="{{url('/assessment/evaluate/'.$assessment->id)}}" class="list-group-item">Assessment #{{$assessment->id}}</a>
        @endforeach
    @endif
</div>
...
<div class="list-group">
    ...
    @else
        ...
        @foreach($assessment->where('assessment_checklist_type_id',94)->whereNotIn('assessment_status_id',[4]) as $assessment)
            <a href="{{url('/assessment/evaluate/'.$assessment->id)}}" class="list-group-item">Assessment #{{$assessment->id}}</a>
        @endforeach
    @endif
</div>	
...
<div class="list-group">
    ...
    @else
        ...
        @foreach($assessment->where('assessment_checklist_type_id',95)->whereNotIn('assessment_status_id',[4]) as $assessment)
            <a href="{{url('/assessment/evaluate/'.$assessment->id)}}" class="list-group-item">Assessment #{{$assessment->id}}</a>
        @endforeach
    @endif
</div>
