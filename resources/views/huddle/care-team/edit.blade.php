        ...
        {!! Form::open(['url' => 'system-admin/huddle/care-teams/'.$care_team->id.'/edit', 'class' => 'form-horizontal']) !!}
            ...
            <div id="report-to-picker" style="display:none">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                    {!! Form::select('report_to_care_teams[]', $care_team->tier->careTeams->pluck('name','id'), $report_to_care_teams, ['class' => 'form-control selectpicker','id' => 'report_to_care_teams','data-live-search' => "true"]); !!}
                    </div>
                </div>
            ...
            <div id="building-picker" @if($care_team->tier_id == 1) style="display:block" @else style="display:none" @endif>

                <div class="form-group">
                    {!! Form::label('hco_id', 'HCO:', ['class' => 'col-lg-2 control-label']) !!}
                    <div class="col-lg-10">
                    {!! Form::select('hco_id', $hcos->prepend('Please Select',''), $care_team->hcos->first()->id, ['class' => 'form-control selectpicker','id' => 'hco_id']); !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                    {!! Form::select('site_id', \App\Regulatory\Site::where('hco_id', $care_team->hcos->first()->id)->pluck('name','id'), $care_team->sites->first()->id, ['class' => 'form-control','id' => 'site_id','data-live-search' => "true"]); !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                    {!! Form::select('building_id', \App\Regulatory\Building::where('site_id', $care_team->sites->first()->id)->pluck('name','id'), $care_team->buildings->first()->id, ['class' => 'form-control','id' => 'building_id','data-live-search' => "true"]); !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                    {!! Form::select('department_id', \App\Regulatory\BuildingDepartment::where('building_id', $care_team->buildings->first()->id)->pluck('name','id'), $care_team->departments->first()->id, ['class' => 'form-control selectpicker','id' => 'department_id','data-live-search' => "true"]); !!}
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                {!! Form::text('location', $care_team->location, ['class' => 'form-control','id' => 'location']) !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                {!! Form::select('leader_user_id', $users->prepend('Please Select',0), $care_team->leader_user_id, ['class' => 'form-control selectpicker','id' => 'leader_user_id','data-live-search' => "true"]); !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                {!! Form::select('alternative_leader_user_id', $users->prepend('Please Select',0), $care_team->leader_user_id, ['class' => 'form-control selectpicker','id' => 'alternative_leader_user_id','data-live-search' => "true"]); !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                {!! Form::select('recorder_of_data_user_id', $users->prepend('Please Select',0), $care_team->recorder_of_data_user_id, ['class' => 'form-control selectpicker','id' => 'recorder_of_data_user_id','data-live-search' => "true"]); !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                {!! Form::select('alternative_recorder_of_data_user_id', $users->prepend('Please Select',0), $care_team->alternative_recorder_of_data_user_id, ['class' => 'form-control selectpicker','id' => 'alternative_recorder_of_data_user_id','data-live-search' => "true"]); !!}
                </div>
            </div>
