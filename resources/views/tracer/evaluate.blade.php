...
@endsection
@section('page_title','Tracer Evaluation Questions for '.$tracer->created_at->setTimezone(session('timezone'))->toDayDateTimeString())
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Tracer Leader</span>
              <span class="info-box-number">{{$tracer->user->name}}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">{{$tracer->checklistType->name}}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">{{$tracer->department->name}}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
            ...
            @foreach($category->questions as $question)
                <div class="box box-widget">
                    ...
                    <div class="box-body">
                        ...
                        <span class="pull-right text-muted">{{$tracer->evaluations->where('question_id',$question->id)->count()}} findings</span>
                    </div>
                    <!-- /.box-body -->
                    ...
                    <div id="box-footer-{{$question->id}}" class="box-footer box-comments">
                        ...
                        @foreach($tracer->evaluations->where('question_id',$question->id) as $finding)
...
<div id="verifyModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      {!! Form::open(['url' => '/tracer/question/findings/verify', 'class' => 'form-horizontal']) !!}
          <p>All the findings noted below are verified and ready for submission.</p>
          {!! Form::hidden('tracer_id', $tracer->id,['id' => '']) !!}
      </div>
      <div class="modal-footer">
...
$('.answer').change(function(){
    ...
    if($(this).val())
    {
        ...
        if($(this).val() == $(this).attr('data-negative'))
        {
            ...
            var directory = 'tracer/'+tracer_id+'/question/'+question_id+'/user/'+user_id+'/findings/'+moment().unix();
...
$('#inventory-checkbox').change(function(){
    ...
    $(document).on('click', '.confirm-finding', function () {
        ...
        $.ajax({
           type: 'POST',
           url: ($('#is_edit').val() == 1) ? '{{ url('tracer/'.$tracer->id.'/question/findings/edit') }}' : '{{ url('tracer/'.$tracer->id.'/question/findings') }}',
           data: { 
             '_token' : '{{ csrf_token() }}',
             'tracer_id' : tracer_id,
